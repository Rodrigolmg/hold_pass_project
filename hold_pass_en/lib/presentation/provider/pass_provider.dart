...
class PassProvider with ChangeNotifier {
  ...
  PasswordModel? _passToEdit;
  PasswordModel? _passToRegister;
  PasswordModel? _passToDelete;
  List<PasswordModel>? _listPassEmail;
  ...
  void setPasswordToEdit(PasswordModel passToEdit){
  ...
  void setPasswordToDelete(PasswordModel passToDelete) {
  ...
  PasswordModel? get getPassToEdit => _passToEdit;
  PasswordModel? get getPassToRegister => _passToRegister;
  PasswordModel? get getPassToDelete => _passToDelete;

  List<PasswordModel>? get getEmails => _listPassEmail;
